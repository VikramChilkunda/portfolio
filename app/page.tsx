		...
		<>
			...
			<main className='bg-gradient-to-r from-fuchsia-500 to-cyan-500 pl-5 h-screen flex flex-col items-center'>
				<div className='flex flex-col lg:flex-row items-center justify-center h-fit my-auto  max-w-[80%] mx-auto'>
					<div className="max-w-full mb-10 lg:mb-0 font-bold text-7xl lg:text-8xl text-black h-fit uppercase flex flex-col justify-center lg:mr-16">
						...
						<p className='text-4xl lg:text-5xl overflow-hidden whitespace-nowrap ml-2 inline-block max-w-fit tracking-tight animate-typing'>full stack developer</p>
					</div>
